...
function start() {
    ...
    if (array === null || array.length === 0) {
        $(".container").append("<h3 class='bin_empty'>Cart Is Empty</h3>");
        ...
        $("#make_order_create").append("<button onclick='showForm()' id=\"make_order\" type=\"button\" class=\"btn btn-outline-dunger\">Make Order</button>\n");
